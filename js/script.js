...
$(window).scroll(function () {
    ...
    $('section').each(function (i) {
        ...
        if (tg.offset().top - 10 < $sct) { //해당 컨텐츠의 화면 상단에서의 거리 < 현재 스크롤
...
setInterval(function () {
    ...
    if (activeIndex == 4) {
        $(".cs-exp-list>li").eq(0).addClass("active").siblings().removeClass("active");
    } else {
        $(".cs-exp-list>li").eq(activeIndex - 1).addClass("active").siblings().removeClass("active");
    }
}, 100)
